...
@Component({
  selector: 'app-create-stock-out',
  templateUrl: './create-stock-out.component.html',
  styleUrls: ['./create-stock-out.component.css']
})
export class CreateStockOutComponent implements OnInit {
